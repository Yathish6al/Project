# -*- coding: utf-8 -*-
"""
Created on Fri Apr 16 18:36:42 2021
...
def prediction(number, incident_state, opened_by, opened_at, sys_updated_by,
       sys_updated_at,subcategory,urgency,priority, resolved_by, resolved_at, closed_at):  
   
    prediction = model.predict([[number, incident_state, opened_by, opened_at, sys_updated_by,sys_updated_at,subcategory,urgency,priority,resolved_by, resolved_at, closed_at]])
    print(prediction)
    return prediction
...
def main():
    ...
    st.title("PREDICTIONS FOR IMPACT")
      
    # here we define some of the front end elements of the web page like 
    # the font and background color, the padding and the text to be displayed
    html_temp = """
    <div style ="background-color:aqua;padding:13px">
    <h1 style ="color:black;text-align:center;">Search below for predicting Impact of Incidents</h1>
    </div>
    """
